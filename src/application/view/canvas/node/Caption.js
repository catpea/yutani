...
export default class Caption extends Component {
	...
	setup() {
		...
		this.el.CaptionText = svg.text({ class: `node-caption caption-text node-text`, style:'pointer-events: none; user-select: none;', x:this.x+(this.width*.02), y: this.y + (this.height - (this.height * .12)) }, this.data.type);
